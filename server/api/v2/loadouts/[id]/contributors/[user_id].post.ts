/** 
 * @file [...].post.ts
 * @description API to add a contributor
 * 
 * @route /api/v2/loadouts/:id/contributors/:user_id
 * @method POST
 */
...
/**
 * API handler for adding contributors.
 *
...
export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    return await categoryRepository.add(loadoutId, userId);
  } catch (e: any) {
    console.error(e);
    throw createError({
